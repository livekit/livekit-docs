...
When audio tracks are published, LiveKit will detect participants that are speaking. Speaker updates are sent for both local and remote participants. They will fire on both Room and each participant.
