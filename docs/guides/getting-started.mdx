...
You can generate a development access token by subbing a unique identifier for <mark style={{backgroundColor: "#f5f5f5", fontFamily: 'Courier', color: "#333", fontWeight: "bold"}}>$participant_identity</mark> in the following command:
